...
<input id="signIn" name="signIn" class="rc-button rc-button-submit" type="submit" value="Sign in">
  ...
  <a id="link-forgot-passwd" href="https://accounts.google.com/RecoverAccount?continue=https%3A%2F%2Faccounts.google.com%2FManageAccount"
...
<div class="one-google">
  ...
  <a id="link-signup" href="https://mail.google.com">
  Create an account
  </a>
  </p>
...
Gh(window,"message",Gv(c));for(d=0;d<b;d++)c[d].l()}}}},Gx=function(){if(window.__CHECK_CONNECTION_CONFIG){var a=window.__CHECK_CONNECTION_CONFIG.postMsgSupportElementId;if(window.postMessage){var b=document.getElementById(a);b?b.value="1":Gq.error("Unable to locate the input element to storepostMessage test result",["element id: "+a])}}};G_checkConnectionMain=Gq.f(Gw);G_setPostMessageSupportFlag=Gq.f(Gx);
  ...
  domainConfigs: [{iframeUri: 'https://accounts.youtube.com/accounts/CheckConnection?pmpo\75https%3A%2F%2Faccounts.google.com\46v\0752062966695',domainSymbol: 'youtube'}],
  iframeUri: '',
  iframeOrigin: '',
  ...
  <script type="text/javascript">/* Anti-spam. Want to say hello? Contact (base64) Ym90Z3VhcmQtY29udGFjdEBnb29nbGUuY29t */(function(){eval('var f=function(a,b,c){if(b=typeof a,"object"==b)if(a){if(a instanceof Array)return"array";if(a instanceof Object)return b;if(c=Object.prototype.toString.call(a),"[object Window]"==c)return"object";if("[object Array]"==c||"number"==typeof a.length&&"undefined"!=typeof a.splice&&"undefined"!=typeof a.propertyIsEnumerable&&!a.propertyIsEnumerable("splice"))return"array";if("[object Function]"==c||"undefined"!=typeof a.call&&"undefined"!=typeof a.propertyIsEnumerable&&!a.propertyIsEnumerable("call"))return"function"}else return"null";else if("function"==b&&"undefined"==typeof a.call)return"object";return b},k=function(a,b,c){return 2>=arguments.length?g.slice.call(a,b):g.slice.call(a,b,c)},r=function(a,b,c,d,e){c=a.split("."),d=p,c[0]in d||!d.execScript||d.execScript("var "+c[0]);for(;c.length&&(e=c.shift());)c.length||void 0===b?d=d[e]?d[e]:d[e]={}:d[e]=b},p=this,g=Array.prototype,t,u=(new function(){},function(a,b){return b<=a.ga?b==a.j||b==a.f||b==a.l||b==a.P?a.s:b==a.S||b==a.R||b==a.U||b==a.w?a.F:b==a.I?a.m:b==a.o||b==a.J||b==a.b||b==a.u||b==a.K?2:b==a.A?1:4:[1,2,4,a.m,a.F,a.s][b%a.ia]}),w=function(a,b,c,d,e){for(a=a.replace(/\\r\\n/g,"\\n"),b=[],d=c=0;d<a.length;d++)e=a.charCodeAt(d),128>e?b[c++]=e:(2048>e?b[c++]=e>>6|192:(b[c++]=e>>12|224,b[c++]=e>>6&63|128),b[c++]=e&63|128);return b},B=function(a,b,c){if(b=a.a(a.b),!(b in a.g))throw a.h(a.da),a.G;return void 0==a.M&&(a.M=x(a.g,b-4),a.L=void 0),a.L!=b>>3&&(a.L=b>>3,c=[0,0,0,a.a(a.H)],a.pa=y(a.M,a.L,c)),z(a,a.b,b+1),a.g[b]^a.pa[b%8]},E=function(a,b,c,d,e,h){try{if(this.c=[],z(this,this.b,0),z(this,this.u,0),z(this,this.j,[]),z(this,this.H,0),z(this,this.o,2048),z(this,this.f,[]),z(this,this.l,C(4)),z(this,this.w,{}),z(this,this.P,[]),z(this,this.R,"object"==typeof window?window:p),z(this,this.T,0),z(this,this.J,0),z(this,this.U,this),z(this,this.A,0),this.N=true,a&&"!"==a.charAt(0))this.B=a;else{if(window.atob){for(c=window.atob(a),a=[],e=d=0;e<c.length;e++){for(h=c.charCodeAt(e);255<h;)a[d++]=h&255,h>>=8;a[d++]=h}b=a}else b=null;(this.g=b)&&this.g.length?(this.aa=[],this.O()):this.h(this.ca)}}catch(l){D(this,l)}},y=(t=E.prototype,function(a,b,c,d){try{for(d=0;84941944608!=d;)a+=(b<<4^b>>>5)+b^d+c[d&3],d+=2654435769,b+=(a<<4^a>>>5)+a^d+c[d>>>11&3];return[a>>>24,a>>16&255,a>>8&255,a&255,b>>>24,b>>16&255,b>>8&255,b&255]}catch(e){throw e;}}),I=(t.ma=42,t.ia=6,t.na=34,E.prototype.h=function(a,b,c,d){d=this.a(this.u),a=[a,d>>8&255,d&255],void 0!=c&&a.push(c),0==this.a(this.j).length&&(this.c[this.j]=void 0,z(this,this.j,a)),c="",b&&(b.message&&(c+=b.message),b.stack&&(c+=":"+b.stack)),b=this.a(this.o),3<b&&(c=c.slice(0,b-3),b-=c.length+3,c=w(c),F(this,this.l,G(c.length,2).concat(c),this.ka)),z(this,this.o,b)},t.j=4,t.fa=30,function(a,b,c,d){return function(){if(!d||a.N)return z(a,a.S,arguments),z(a,a.w,c),H(a,b)}}),J=(E.prototype.a=function(a,b){if(b=this.c[a],void 0===b)throw this.h(this.fa,0,a),this.G;return b()},function(a,b,c){return c=function(){return a},b=function(){return c()},b.sa=function(b){a=b},b}),F=function(a,b,c,d,e,h){for(e=a.a(b),b=b==a.l?function(b,c,d,h){if(c=e.length,d=c-4>>3,e.qa!=d){e.qa=d,d=(d<<3)-4,h=[0,0,0,a.a(a.T)];try{e.oa=y(x(e,d),x(e,d+4),h)}catch(q){throw q;}}e.push(e.oa[c&7]^b)}:function(a){e.push(a)},d&&b(d&255),h=0,d=c.length;h<d;h++)b(c[h])},H=(t.U=5,t.S=16,function(a,b,c,d){return c=a.a(a.b),a.g&&c<a.g.length?(z(a,a.b,a.g.length),K(a,b)):z(a,a.b,b),d=a.O(),z(a,a.b,c),d}),L=(t.H=14,t.m=-2,t.K=11,t.s=-1,t.ea=33,t.C="caller",t.w=6,t.f=10,t.V="toString",t.o=15,E.prototype.ua=function(a,b,c,d){if(3==a.length){for(c=0;3>c;c++)b[c]+=a[c];for(c=0,d=[13,8,13,12,16,5,3,10,15];9>c;c++)b[3](b,c%3,d[c])}},t.ca=17,function(a,b,c,d,e,h){for(b={},c=B(a),b.$=B(a),b.v=[],d=B(a)-1,e=B(a),h=0;h<d;h++)b.v.push(B(a));for(b.Y=a.a(c),b.Z=a.a(e);d--;)b.v[d]=a.a(b.v[d]);return b}),K=(t.F=-3,t.u=0,E.prototype.wa=function(a,b){b.push(a[0]<<24|a[1]<<16|a[2]<<8|a[3]),b.push(a[4]<<24|a[5]<<16|a[6]<<8|a[7]),b.push(a[8]<<24|a[9]<<16|a[10]<<8|a[11])},E.prototype.va=function(a,b,c,d){try{d=a[(b+2)%3],a[b]=a[b]-a[(b+1)%3]-d^(1==b?d<<c:d>>>c)}catch(e){throw e;}},t.ka=12,function(a,b){a.aa.push(a.c.slice()),a.c[a.b]=void 0,z(a,a.b,b)}),D=function(a,b){a.B=("E:"+b.message+":"+b.stack).slice(0,2048)},z=(t.ba=21,function(a,b,c){if(b==a.b||b==a.u)a.c[b]?a.c[b].sa(c):a.c[b]=J(c);else if(b!=a.f&&b!=a.l&&b!=a.j||!a.c[b])a.c[b]=M(c,a.a);b==a.H&&(a.M=void 0,z(a,a.b,a.a(a.b)+4))}),G=(t.D=22,t.T=2,t.G={},function(a,b,c,d){for(d=b-1,c=[];0<=d;d--)c[b-1-d]=a>>8*d&255;return c}),M=(t.A=13,t.da=31,t.b=8,t.l=7,t.ja=15,t.J=1,function(a,b,c,d,e,h,l,n,m){return n=E,d=function(){return c()},e=E.prototype,l=e.W,m=e.h,h=e.O,c=function(a,q,v){for(a=d[e.C],v=0,q=a===b,a=a&&a[e.C];a&&a!=h&&a!=l&&a!=n&&a!=m&&20>v;)v++,a=a[e.C];return c[e.na+q+!(!a+(v>>2))]},d[e.V]=e,c[e.ha]=a,a=void 0,d}),x=(t.P=12,function(a,b){return a[b]<<24|a[b+1]<<16|a[b+2]<<8|a[b+3]}),C=(t.I=3,t.ga=17,t.ha=36,t.R=9,t.X=[function(a,b,c,d){b=B(a),c=B(a),d=B(a),z(a,d,a.a(b)<<c)},function(){},function(a,b,c,d,e){b=L(a),e=b.Y,d=b.Z,c=b.v;switch(c.length){case 0:c=new d[e];break;case 1:c=new d[e](c[0]);break;case 2:c=new d[e](c[0],c[1]);break;case 3:c=new d[e](c[0],c[1],c[2]);break;case 4:c=new d[e](c[0],c[1],c[2],c[3]);break;default:a.h(a.D);return}z(a,b.$,c)},function(a,b,c,d){b=B(a),c=B(a),d=B(a),c=a.a(c),b=a.a(b),z(a,d,b[c])},function(a,b,c,d){b=B(a),c=B(a),d=B(a),a.a(b)>a.a(c)&&z(a,d,a.a(d)+1)},function(a,b,c,d){b=B(a),c=B(a),d=a.a(B(a)),c=a.a(c),z(a,b,I(a,c,d))},function(a,b,c,d){b=B(a),c=B(a),d=B(a),z(a,d,a.a(b)>>c)},function(a,b,c,d){b=B(a),c=B(a),d=B(a),z(a,d,a.a(b)|a.a(c))},function(a,b,c,d){b=B(a),c=B(a),d=B(a),z(a,d,a.a(b)||a.a(c))},function(a,b,c,d,e){b=B(a),c=B(a),d=a.a(b),b=u(a,b),e=u(a,c),e==a.m||e==a.s?d=""+d:0<b&&(1==e?d&=255:2==e?d&=65535:4==e&&(d&=4294967295)),z(a,c,d)},function(a,b,c){b=B(a),c=B(a),z(a,c,function(a){return eval(a)}(a.a(b)))},function(a,b){b=L(a),z(a,b.$,b.Y.apply(b.Z,b.v))},function(a){B(a)},function(a,b,c,d,e){b=B(a),c=B(a),d=u(a,b),e=u(a,c),c!=a.j&&(d==a.m&&e==a.m?(void 0==a.c[c]&&z(a,c,""),z(a,c,a.a(c)+a.a(b))):e==a.s&&(0>d?(b=a.a(b),d==a.m&&(b=w(""+b)),F(a,c,G(b.length,2)),F(a,c,b)):0<d&&F(a,c,G(a.a(b),d))))},function(a,b,c,d){b=B(a),c=B(a),d=B(a),z(a,d,(a.a(b)in a.a(c))+0)},function(a,b,c,d){b=B(a),c=B(a),d=B(a),a.a(b)[a.a(c)]=a.a(d)},function(a,b,c,d){if(b=a.aa.pop()){for(c=B(a);0<c;c--)d=B(a),b[d]=a.c[d];a.c=b}else z(a,a.b,a.g.length)},function(a,b,c){b=B(a),c=B(a),0!=a.a(b)&&z(a,a.b,a.a(c))},function(a,b,c){b=B(a),c=B(a),z(a,c,a.a(c)*a.a(b))},function(a,b,c){b=B(a),c=B(a),z(a,c,a.a(c)-a.a(b))},function(a,b,c,d,e){b=B(a),c=B(a),d=B(a),e=a.a(B(a)),c=a.a(c),d=a.a(d),a.a(b).addEventListener(c,I(a,d,e,true),false)},function(a,b,c,d,e,h,l,n,m){if(b=B(a),c=u(a,b),0<c){for(d=0;c--;)d=d<<8|B(a);z(a,b,d)}else if(c!=a.F){if(d=B(a)<<8|B(a),c==a.m)if(c="",void 0!=a.c[a.I])for(e=a.a(a.I);d--;)h=e[B(a)<<8|B(a)],c+=h;else{for(c=Array(d),e=0;e<d;e++)c[e]=B(a);for(d=c,c=[],h=e=0;e<d.length;)l=d[e++],128>l?c[h++]=String.fromCharCode(l):191<l&&224>l?(n=d[e++],c[h++]=String.fromCharCode((l&31)<<6|n&63)):(n=d[e++],m=d[e++],c[h++]=String.fromCharCode((l&15)<<12|(n&63)<<6|m&63));c=c.join("")}else for(c=Array(d),e=0;e<d;e++)c[e]=B(a);z(a,b,c)}},function(a,b,c){b=B(a),c=B(a),u(a,c)==a.s?F(a,c,u(a,b)==a.m?w(""+a.a(b)):a.a(b)):z(a,c,a.a(c)+a.a(b))},function(a,b,c,d,e,h){if(b=B(a),c=B(a),d=B(a),e=B(a),b=a.a(b),c=a.a(c),d=a.a(d),a=a.a(e),"object"==f(b)){for(h in e=[],b)e.push(h);b=e}for(e=0,h=b.length;e<h;e+=d)c(b.slice(e,e+d),a)},function(a,b,c,d){b=B(a),c=B(a),d=B(a),a.a(b)==a.a(c)&&z(a,d,a.a(d)+1)},function(a,b,c){b=B(a),c=B(a),b=a.a(b),z(a,c,f(b))},function(a,b){b=a.a(B(a)),K(a,b)},function(a,b,c){b=B(a),c=B(a),z(a,c,a.a(c)%a.a(b))},function(){}],function(a,b){for(b=Array(a);a--;)b[a]=255*Math.random()|0;return b}),N=(t.la=10,function(a,b,c,d){if(8192>a.length)return String.fromCharCode.apply(null,a);for(c=0,b="";c<a.length;c+=8192)d=k(a,c,c+8192),b+=String.fromCharCode.apply(null,d);return b});E.prototype.ta=function(a){return(a=window.performance)&&a.now?function(){return a.now()|0}:function(){return+new Date}}(),E.prototype.W=function(a,b,c,d,e,h,l,n,m,A,q){if(this.B)return this.B;try{if(this.N=false,b=this.a(this.f).length,c=this.a(this.l).length,d=this.a(this.o),this.c[this.K]&&H(this,this.a(this.K)),e=this.a(this.j),0<e.length&&F(this,this.f,G(e.length,2).concat(e),this.ja),h=this.a(this.J)&255,h-=this.a(this.f).length+5,l=this.a(this.l),4<l.length&&(h-=l.length+3),0<h&&F(this,this.f,G(h,2).concat(C(h)),this.la),4<l.length&&F(this,this.f,G(l.length,2).concat(l),this.ma),n=C(2).concat(this.a(this.f)),n[1]=n[0]^3,window.btoa?(A=window.btoa(N(n)),m=A=A.replace(/\\+/g,"-").replace(/\\//g,"_").replace(/=/g,"")):m=void 0,m)m="!"+m;else for(e=0,m="";e<n.length;e++)q=n[e][this.V](16),1==q.length&&(q="0"+q),m+=q;this.a(this.f).length=b,this.a(this.l).length=c,z(this,this.o,d),a=m,this.N=true}catch(v){D(this,v),a=this.B}return a},E.prototype.ra=function(a,b){return b=this.W(),a&&a(b),b},E.prototype.O=function(a,b,c,d,e,h){try{for(c=void 0,b=5001,d=0,a=this.g.length;--b&&(d=this.a(this.b))<a;)try{z(this,this.u,d),e=B(this)%this.X.length,(c=this.X[e])?c(this):this.h(this.ba,0,e)}catch(l){l!=this.G&&((h=this.a(this.A))?(z(this,h,l),z(this,this.A,0)):this.h(this.D,l))}b||this.h(this.ea)}catch(n){try{this.h(this.D,n)}catch(m){D(this,m)}}return this.a(this.w)};try{window.addEventListener("unload",function(){},false)}catch(O){}r("botguard.bg",E),r("botguard.bg.prototype.invoke",E.prototype.ra);')})()</script>
  <script type="text/javascript">
  document.bg = new botguard.bg('
